...
const text =
  "I have inspired in a lot of differents things, like music, fashion, sports, youtubers, etc. One of my biggets goals is create a design to a popular designer in the music industry, working with artist like Blessd, Pirlo, etc. ";
