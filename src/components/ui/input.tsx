      ...
      >
        <input
          ...
          className={cn(
            ...
            focus-visible:outline-none focus-visible:ring-[2px]  focus-visible:ring-[#FF3E3E]
            disabled:cursor-not-allowed disabled:opacity-50
            dark:shadow-[0px_0px_1px_1px_var(--neutral-700)]
            group-hover/input:shadow-none group-hover/input:border-[#FF3E3E] group-hover/input:ring-[#FF3E3E]
